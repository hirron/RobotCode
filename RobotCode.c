...
#pragma config(Motor,  port3,           motor2,        tmotorVex393, openLoop)
...
task main()
{
    ...
    while(true){
        ...
        case MoveState:
            ...
            int static motorSpeed=50; // function slows speed as robot draws nearer
            motor[motor1]=motorSpeed;
            // if close enough, motor is shut off, drop state entered
